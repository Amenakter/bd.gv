...
<section class="cont">
    <div class="row logo">
        <div class="col-sm-4 logo-left">
               <a href="">
                <?php the_custom_logo();?>
               <!-- <img src="<?= get_template_directory_uri();?>./assets/images/header/logo_bn.png" alt=""></a> -->
        </div>
     ...
     <!-- slider end -->
            <div class="tab">
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="pills-disabled-tab" data-bs-toggle="pill" data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact-tab" aria-selected="false">দপ্তর ভিত্তিক সেবা</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-disabled-tab" data-bs-toggle="pill" data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-profile-tab" aria-selected="false">সকল ই-সেবা</button>
                    </li>
                  </ul>
                  <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade" id="pills-contact-tab" role="tabpanel" aria-labelledby="pills-contact-tab" tabindex="0">
                      <div class="row">
                          <div class="col-lg-2 text-center">
                              <a href="#"><img src="<?= get_template_directory_uri();?>./assets/images/tab/agriculture.png" alt=""></a>
                              <p>কৃষি</p>
                      ...
                      <div class="tab-pane fade" id="pills-profile-tab" role="tabpanel" aria-labelledby="pills-contact-tab" tabindex="0">
                        <div class="row">
                            <div class="col-lg-2 text-center">
                                <a href="#"><img src="<?= get_template_directory_uri();?>./assets/images/tab/agriculture.png" alt=""></a>
                                <p>কৃষি</p>
